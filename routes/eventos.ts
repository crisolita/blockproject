...
router.post("/createEvent",validator.body(querySchemaCreateEvent),upload.fields([{name:'profile',maxCount:1},{name:'banner',maxCount:1}]), authenticateToken,createEvent);
