...
import {   createEvent, getAll, getEvent, updateEvent } from "../controllers/eventos";
...
router.put("/updateEvent",upload.fields([{name:'profile',maxCount:1},{name:'banner',maxCount:1}]),isOrganizador, updateEvent);
